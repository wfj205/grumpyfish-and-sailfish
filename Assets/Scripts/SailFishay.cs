...
public class SailFishay : MonoBehaviour {
	...
	void SetNewDestination(){
		...
		destination = Random.insideUnitSphere*300f; //this unit sphere is normalized with a radius of 1. we can multiply it by stuff to make the sphere bigger
	}
}